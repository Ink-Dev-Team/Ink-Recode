...
public class ModuleComponent implements IComponent {
    ...
    public ModuleComponent(Module module) {
        ...
        for (Value<?> value : module.values) {
            ...
            } else if (value instanceof ModeValue modeComponent) {
    ...
    public void render(DrawContext guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        NanoVGRenderer.INSTANCE.draw(vg -> {
            ...
            NanoVGHelper.drawString(module.name, x + 4 * scale, y + 11 * scale, FontLoader.regular(baseFontSize * 0.75f), baseFontSize * 0.75f, Color.WHITE);
