package com.ink.recode.render.font;
...
public class Fonts {
    ...
    private static final String REGULAR = "OPPOSans-Regular.ttf";
    private static final String MEDIUM = "OPPOSans-Medium.ttf";
    private static final String BOLD = "OPPOSans-Bold.ttf";
    private static final String BOREL = "Borel.ttf";
    ...
    public static void loadAll() {
        ...
        FontHelper.preloadFonts(REGULAR, MEDIUM, BOLD);
        loadCustomFonts();
        System.out.println("[Fonts] Fonts loaded successfully");
    }

    private static void loadCustomFonts() {
        try {
            fontDir = new File(MinecraftClient.getInstance().runDirectory, "ink-recode/fonts");
            if (!fontDir.exists()) {
                fontDir.mkdirs();
            }
    ...
    public static Font getBold(float size) {
        return FontHelper.load(BOLD, size);
    }

    public static Font getBorel(float size) {
        return FontHelper.load(BOREL, size);
    }
